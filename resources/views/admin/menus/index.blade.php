            ...
            <table class="min-w-full bg-white text-left border border-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="py-2 px-4 text-sm font-semibold text-gray-600 border-b">Name</th>
                        <th class="py-2 px-4 text-sm font-semibold text-gray-600 border-b">Price</th>
                        <th class="py-2 px-4 text-sm font-semibold text-gray-600 border-b">Category</th>
                ...
                <tbody>
                    @forelse($menus as $menu)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="py-2 px-4 border-b">${{ number_format($menu->price, 2) }}</td>
                            <td class="py-2 px-4 border-b">{{ $menu->category->name ?? '—' }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-4 text-gray-500">No menu items found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
